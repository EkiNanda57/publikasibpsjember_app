    ...
    <div class="min-h-screen flex items-center justify-center p-4 sm:p-6">
        <div class="w-full max-w-sm sm:max-w-md lg:max-w-lg p-6 bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700">
            ...
            <form method="POST" action="{{ route('register.store') }}" class="space-y-5">
                ...
                <button type="submit"
                        class="w-full flex justify-center py-3 px-4 border border-blue-500 rounded-xl
                               shadow-sm text-sm font-medium text-blue-500 bg-white dark:bg-gray-800
                               hover:bg-blue-500 hover:text-white focus:outline-none focus:ring-2
                               focus:ring-offset-2 focus:ring-blue-500 transform hover:scale-[1.01]
