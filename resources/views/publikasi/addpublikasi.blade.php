...
<div class="min-h-screen p-4 sm:p-6"
    ...
    <div class="bg-white shadow-xl rounded-lg p-5 sm:p-6 w-full max-w-4xl mx-auto">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
            ...
            <a href="{{ route('publikasi.publikasi') }}"
               class="w-full sm:w-auto text-center bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-lg">
                Kembali
            </a>
        </div>
        ...
        <form action="{{ route('publikasi.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div id="file_input" class="mb-4 hidden">
                <label class="block font-semibold mb-1">Upload File (PDF/DOC/PPT/XLS)</label>
            ...
            {{-- BUTTON --}}
            <div class="mt-6">
                <button class="w-full sm:w-auto px-5 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg">
                    Simpan Publikasi
                </button>
            </div>
